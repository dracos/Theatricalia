...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.openplaques'
        db.add_column('people_person', 'openplaques', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.openplaques'
        db.delete_column('people_person', 'openplaques')
