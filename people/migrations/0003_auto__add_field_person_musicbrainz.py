...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.musicbrainz'
        db.add_column('people_person', 'musicbrainz', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.musicbrainz'
        db.delete_column('people_person', 'musicbrainz')
    ...
    models = {
        ...
        'people.person': {
            ...
            'musicbrainz': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
