...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.closing_date'
        db.add_column('places_place', 'closing_date', self.gf('fields.ApproximateDateField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.closing_date'
        db.delete_column('places_place', 'closing_date')
