...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field companies on 'Production'
        db.create_table('productions_production_companies', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('production', models.ForeignKey(orm['productions.production'], null=False)),
            ('productioncompany', models.ForeignKey(orm['productions.productioncompany'], null=False))
        ))
        db.create_unique('productions_production_companies', ['production_id', 'productioncompany_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field companies on 'Production'
        db.delete_table('productions_production_companies')
