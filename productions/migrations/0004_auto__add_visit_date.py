...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('productions_visit', 'date', self.gf('fields.ApproximateDateField')(default='', blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Visit.date'
        db.delete_column('productions_visit', 'date')
    ...
    models = {
        ...
        'people.person': {
            ...
            'openplaques': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
        ...
        'places.place': {
            ...
            'closing_date': ('fields.ApproximateDateField', [], {'default': "''", 'blank': 'True'}),
        ...
        'productions.production': {
            ...
            'companies': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'productions'", 'null': 'True', 'blank': 'True', 'through': "'Production_Companies'", 'to': "orm['productions.ProductionCompany']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'productions.production_companies': {
            'Meta': {'object_name': 'Production_Companies'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'production': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['productions.Production']"}),
            'productioncompany': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['productions.ProductionCompany']"})
        },
        ...
        'productions.visit': {
            ...
            'date': ('fields.ApproximateDateField', [], {'default': "''", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'production': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['productions.Production']"}),
