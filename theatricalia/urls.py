...
urlpatterns = [
    ...
    url(r'^tickets/exchange$', auth_views.PasswordChangeView.as_view(), name='password_change'),
    url(r'^tickets/exchanged$', auth_views.PasswordChangeDoneView.as_view(), name='password_change_done'),
    url(r'^tickets/lost$', auth_views.PasswordResetView.as_view(), name='password_reset'),
    url(r'^tickets/lost/done$', auth_views.PasswordResetDoneView.as_view(), name='password_reset_done'),
    url(r'^tickets/lost/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>.+)$', auth_views.PasswordResetConfirmView.as_view(), name='password_reset_confirm'),
    url(r'^tickets/lost/found$', auth_views.PasswordResetCompleteView.as_view(), name='password_reset_complete'),
    url(r'^tickets/returns$', auth_views.LogoutView.as_view(), name='logout'),
