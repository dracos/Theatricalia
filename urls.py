...
urlpatterns = patterns('',
    ...
    url(r'^tickets/(?P<uidb36>[0-9A-Za-z]+)-(?P<token>.+)$', profiles.register_confirm, name='register-confirm'),
    ...
    url('^person/(?P<person>.*)/future$', people.person_productions, {'type':'future'}, name='person-productions-future'),
    url('^person/(?P<person>.*)/past$', people.person_productions, {'type':'past'}, name='person-productions-past'),
    url('^person/(?P<person>.*)/edit$', people.person_edit, name='person-edit'),
    url('^person/(?P<person>.*)\.js$', people.person_js, name='person-json'),
    url('^person/(?P<person>.*)$', people.person, name='person'),

    url('^places$', places.list, name='places_all'),
    url('^places/(?P<letter>[a-z0*])$', places.list, name='places'),
    url('^place/(?P<place>.*)/future$', places.place_productions, {'type':'future'}, name='place-productions-future'),
    url('^place/(?P<place>.*)/past$', places.place_productions, {'type':'past'}, name='place-productions-past'),
    url('^place/(?P<place>.*)$', places.place, name='place'),
